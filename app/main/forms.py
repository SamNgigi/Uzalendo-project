...
class ReportForm(FlaskForm):
    ...
    department=StringField('Department',choices=[('ict','ICT'),
                                                 ('finance','Finance'),
                                                 ('admin','Administration'),
                                                 ('procurement','Procurement')],validators=[Required()])

    category=RadioField('Type of Institution',choices=[('private','Private'),
                                                      ('public','Public')],validators=[Required()])

    location=SelectField('Location',choices=[('westlands','Westlands'),
                                             ...
                                             ('kamkunji','Kamkunji'),
                                             ('starehe','Starehe'),
                                             ('mathare','Mathare')],validators=[Required()])
    ...
    title=RadioField('Type of crime',choices=[('bribe','Bribery'),
                                              ...
                                              ('nepotism','Nepotism'),
                                              ('tribalism','Tribalism'),
                                              ('harrasment','Harrasment')],validators=[Required()])
